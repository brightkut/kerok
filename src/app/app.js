...
var mongo_db_adapter_1 = require("../mongo-db-adapter");
var App = /** @class */ (function () {
    ...
    App.prototype.listen = function (dbName, connectionOption) {
        var _this = this;
        this.app.listen(this.port, function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, mongo_db_adapter_1.MongoConnection.getConnection().connect(dbName, connectionOption)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
